...
struct MastodonStateRestoration: PersistableRecord, Decodable, FetchableRecord {
    static let databaseTableName: String = "state_restoration"
    
    var systemPersistentIdentifier: String
    var userId: String?
    var displayingScreen: String = ""
    ...
    func encode(to container: inout PersistenceContainer) {
        ...
        container["displaying_screen"] = displayingScreen
    }
